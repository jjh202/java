...
public class TimeTest {
	public static void main(String[] args) {
		...
		LocalDateTime dt = LocalDateTime.now(); // 날짜와 시간 모두를 가지는 클래스
		
		System.out.println("오늘 날짜 : "+date);
		System.out.println("현재 시간 : "+time);
		System.out.println("오늘 날짜와 현재 시간 : "+dt);
		...
		s += dt.getMinute() + "분 ";
		s += dt.getSecond() + "초 ";
		System.out.println("오늘 날짜와 현재 시간 : "+s);
		
		System.out.println("오늘부터 100일 기념일은 : "+date.plusDays(100));
		System.out.println("오늘부터 10주후의 날짜 : "+date.plusWeeks(10));
	}
